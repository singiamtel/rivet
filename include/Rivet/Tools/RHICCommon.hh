// -*- C++ -*-
#ifndef RIVET_TOOLS_RHICCOMMON_HH
#define RIVET_TOOLS_RHICCOMMON_HH

/// @todo Remove this backward-compatibility redirect header
#include "Rivet/Projections/RHICCommon.hh"
