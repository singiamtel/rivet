...
namespace Rivet {
  ...
  class D0_2009_I826756 : public Analysis {
  public:

    RIVET_DEFAULT_ANALYSIS_CTOR(D0_2009_I826756);
    ...
    void analyze(const Event& event) {
      ...
      if (zfinder.bosons().size() == 1) {
        ...
        Jets jets = apply<JetFinder>(event, "ConeFinder").jetsByPt(Cuts::pT > 20*GeV && Cuts::abseta < 2.8);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(D0_2009_I826756, D0_2009_S8349509);
