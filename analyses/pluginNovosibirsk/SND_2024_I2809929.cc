...
namespace Rivet {
  ...
  /// @brief e+ e- > n nbar
  class SND_2024_I2809929 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(SND_2024_I2809929);
  ...
  RIVET_DECLARE_PLUGIN(SND_2024_I2809929);
