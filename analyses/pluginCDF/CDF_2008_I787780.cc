...
namespace Rivet {
  ...
  class CDF_2008_I787780 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(CDF_2008_I787780);
    ...
    void init() {
      ...
      declare(fs, "FS");
      FastJets jetproj(fs, JetAlg::CDFMIDPOINT, 0.7);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(CDF_2008_I787780, CDF_2008_S7782535);
