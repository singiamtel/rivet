...
namespace Rivet {
  ...
  class CDF_2010_I849042_DY : public Analysis {
  public:

    RIVET_DEFAULT_ANALYSIS_CTOR(CDF_2010_I849042_DY);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(CDF_2010_I849042_DY, CDF_2010_S8591881_DY);
