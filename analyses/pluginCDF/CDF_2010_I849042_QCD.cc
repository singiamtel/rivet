...
namespace Rivet {
  ...
  class CDF_2010_I849042_QCD : public Analysis {
  public:

    RIVET_DEFAULT_ANALYSIS_CTOR(CDF_2010_I849042_QCD);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(CDF_2010_I849042_QCD, CDF_2010_S8591881_QCD);
