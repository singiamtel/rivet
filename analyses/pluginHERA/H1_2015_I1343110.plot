...
Title= DIS
XLabel=$x_{\mathbb{P}}$
YLabel=$\mathrm{d}\sigma / \mathrm{d} x_{\mathbb{P}}$
LogY=0
RatioPlotYMin=0.1
RatioPlotYMax=2.2
# END PLOT
...
Title=DIS
XLabel=$y$
YLabel=$\mathrm{d}\sigma / \mathrm{d} y$
LogY=0
RatioPlotYMin=0.1
RatioPlotYMax=2.2
# END PLOT
...
YLabel=$\mathrm{d}\sigma / \mathrm{d} E_{\mathrm{T}}^{\mathrm{jet1}}$
LogY=1
RatioPlotYMin=0.1
RatioPlotYMax=2.2
# END PLOT
...
Title=DIS
XLabel=$M_X$
YLabel=$\mathrm{d}\sigma / \mathrm{d} M_X$
LogY=0
RatioPlotYMin=0.1
RatioPlotYMax=2.2
# END PLOT
