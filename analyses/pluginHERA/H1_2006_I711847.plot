...
RatioPlotSameStyle=1
LogY=0
LegendTitle=$x_{\gamma} < 0.8$\\$M_{\rm jj} > 65$ GeV
# END PLOT
...
RatioPlotSameStyle=1
LegendTitle=$x_{\gamma} < 0.8$\\$\eta_{1,2} < 1$
# END PLOT
...
YLabel=$\mathrm{d}\sigma / \mathrm{d}x_{\rm p}$ [pb]
RatioPlotSameStyle=1
LegendTitle=$x_{\gamma} < 0.8$\\$\eta_i < 1,\,\eta_j > 1 $
# END PLOT
