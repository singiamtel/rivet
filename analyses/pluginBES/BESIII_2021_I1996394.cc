...
namespace Rivet {
  ...
  /// @brief measurement of R 2.2324 to 3.6710 GeV
  class BESIII_2021_I1996394 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(BESIII_2021_I1996394);
  ...
  RIVET_DECLARE_PLUGIN(BESIII_2021_I1996394);
