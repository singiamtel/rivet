...
namespace Rivet {
  ...
  class CMS_2011_I886332 : public Analysis {
  public:

    RIVET_DEFAULT_ANALYSIS_CTOR(CMS_2011_I886332);


    /// Initialization, called once before running
    void init() {
      // Projections
      const FastJets jets(FinalState((Cuts::etaIn(-5.0, 5.0))), JetAlg::ANTIKT, 0.5);
      declare(jets, "Jets");
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(CMS_2011_I886332, CMS_2011_S8957746);
