...
namespace Rivet {
  ...
  public:
    ...
    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(CMS_2016_I1491950);
    ...
    void finalize()
    {
      scale(_hist_thadpt, crossSection()/picobarn/sumOfWeights());
      scale(_hist_thady, crossSection()/picobarn/sumOfWeights());
      scale(_hist_tleppt, crossSection()/picobarn/sumOfWeights());
      scale(_hist_tlepy, crossSection()/picobarn/sumOfWeights());
      scale(_hist_ttpt, crossSection()/picobarn/sumOfWeights());
      scale(_hist_tty, crossSection()/picobarn/sumOfWeights());
      scale(_hist_ttm, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njet, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_thadpt_1, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_thadpt_2, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_thadpt_3, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_thadpt_4, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_ttpt_1, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_ttpt_2, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_ttpt_3, crossSection()/picobarn/sumOfWeights());
      scale(_hist_njets_ttpt_4, crossSection()/picobarn/sumOfWeights());
      scale(_hist_thady_thadpt_1, crossSection()/picobarn/sumOfWeights()/0.5);
      scale(_hist_thady_thadpt_2, crossSection()/picobarn/sumOfWeights()/0.5);
      scale(_hist_thady_thadpt_3, crossSection()/picobarn/sumOfWeights()/0.5);
      scale(_hist_thady_thadpt_4, crossSection()/picobarn/sumOfWeights()/1.0);
      scale(_hist_ttm_tty_1, crossSection()/picobarn/sumOfWeights()/150.);
      scale(_hist_ttm_tty_2, crossSection()/picobarn/sumOfWeights()/175.);
      scale(_hist_ttm_tty_3, crossSection()/picobarn/sumOfWeights()/225.);
      scale(_hist_ttm_tty_4, crossSection()/picobarn/sumOfWeights()/1150.);
      scale(_hist_ttpt_ttm_1, crossSection()/picobarn/sumOfWeights()/35.);
      scale(_hist_ttpt_ttm_2, crossSection()/picobarn/sumOfWeights()/45.);
      scale(_hist_ttpt_ttm_3, crossSection()/picobarn/sumOfWeights()/60.);
      scale(_hist_ttpt_ttm_4, crossSection()/picobarn/sumOfWeights()/360.);
    ...
    public:
      ...
      SpecialLeptonFinder(const FinalState& fs, const Cut& cut)
        : FinalState(cut) {
        setName("CMS_2016_I1491950::SpecialLeptonFinder");
