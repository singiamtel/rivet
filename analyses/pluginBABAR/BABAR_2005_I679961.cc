...
namespace Rivet {
  ...
  class BABAR_2005_I679961 : public Analysis {
  public:

    RIVET_DEFAULT_ANALYSIS_CTOR(BABAR_2005_I679961);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(BABAR_2005_I679961, BABAR_2005_S6181155);
