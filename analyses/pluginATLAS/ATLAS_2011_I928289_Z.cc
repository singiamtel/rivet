...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      ZFinder zfinder_ee_bare(   fs, cut, PID::ELECTRON, 66.0*GeV, 116.0*GeV, 0.0, PhotonOrigin::NODECAY, PhotonsAsConstituents::NO);
      ZFinder zfinder_ee_dressed(fs, cut, PID::ELECTRON, 66.0*GeV, 116.0*GeV, 0.1, PhotonOrigin::NODECAY, PhotonsAsConstituents::NO);
      ZFinder zfinder_mm_bare(   fs, cut, PID::MUON    , 66.0*GeV, 116.0*GeV, 0.0, PhotonOrigin::NODECAY, PhotonsAsConstituents::NO);
      ZFinder zfinder_mm_dressed(fs, cut, PID::MUON    , 66.0*GeV, 116.0*GeV, 0.1, PhotonOrigin::NODECAY, PhotonsAsConstituents::NO);
