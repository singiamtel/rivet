...
YLabel=$1/\sigma \langle N_\mathrm{jet}^\mathrm{gap} \rangle \mathrm{d}\sigma / \mathrm{d}C_j$
# END PLOT

# BEGIN PLOT /ATLAS_2017_I1517194/d16-x01-y01
Title=QCD+EW $Wjj$ inclusive region with $M_{jj} > 1.5$ TeV: $W\to\ell\nu$
XLabel=Lepton centrality
YLabel=$1/\sigma \mathrm{d}\sigma / \mathrm{d}C_\ell$
# END PLOT
...
Title=QCD+EW $Wjj$ inclusive region with $M_{jj} > 1.5$ TeV: $W\to\ell\nu$
XLabel=Jet centrality
YLabel=$\langle N_\mathrm{jet}^\mathrm{gap} \rangle \mathrm{d}\sigma / \mathrm{d}C_j$ [fb]
# END PLOT

# BEGIN PLOT /ATLAS_2017_I1517194/d69-x01-y01
Title=QCD+EW $Wjj$ inclusive region with $M_{jj} > 1.5$ TeV: $W\to\ell\nu$
XLabel=Lepton centrality
YLabel=$\mathrm{d}\sigma / \mathrm{d}C_\ell$ [fb]
# END PLOT

# BEGIN PLOT /ATLAS_2017_I1517194/d70-x01-y01
Title=QCD+EW $Wjj$ inclusive region with $M_{jj} > 1.5$ TeV: $W\to\ell\nu$
XLabel=Number of jets in the rapidity gap
YLabel=$\mathrm{d}\sigma / \mathrm{d}N_\mathrm{jets}^\mathrm{gap}$ [fb]
# END PLOT
