...
namespace Rivet {
  ...
  class ATLAS_2011_I890749 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(ATLAS_2011_I890749);
  ...
  RIVET_DECLARE_ALIASED_PLUGIN(ATLAS_2011_I890749, ATLAS_2011_S8983313);
