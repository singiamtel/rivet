  ...
  public:
    ...
    void analyze(const Event& event) {
      ...
      if( min_dPhi_2 > 0.4 && eTmiss/m_eff_Nj > 0.3 ) {
        _hist_meff_A_tight ->fill(m_eff_inc);
        if(eTmiss/m_eff_Nj > 0.4)
          _hist_meff_A_medium->fill(m_eff_inc);
        if(m_eff_inc>1900.)
          _count_A_tight ->fill(0.5);
        if(m_eff_inc>1300. && eTmiss/m_eff_Nj > 0.4)
          _count_A_medium->fill(0.5);
        if(m_eff_inc>1300. && eTmiss/m_eff_Nj > 0.4)
          _count_A_loose ->fill(0.5);
      }
      ...
      if( min_dPhi_3 > 0.4 && eTmiss/m_eff_Nj > 0.25 ) {
        _hist_meff_B_tight->fill(m_eff_inc);
        if(eTmiss/m_eff_Nj > 0.3)
          _hist_meff_B_medium->fill(m_eff_inc);
        if(m_eff_inc>1900.)
          _count_B_tight ->fill(0.5);
        if(m_eff_inc>1300. && eTmiss/m_eff_Nj > 0.3)
          _count_B_medium->fill(0.5);
      }
      ...
      if( min_dPhi_3 > 0.4 && min_dPhi_All > 0.2 && eTmiss/m_eff_Nj > 0.25 ) {
        _hist_meff_C_tight->fill(m_eff_inc);
        if( eTmiss/m_eff_Nj > 0.3 )
          _hist_meff_C_medium->fill(m_eff_inc);
        if(m_eff_inc>1900.)
          _count_C_tight ->fill(0.5);
        if(m_eff_inc>1300. && eTmiss/m_eff_Nj > 0.3)
          _count_C_medium->fill(0.5);
        if(m_eff_inc>1000. && eTmiss/m_eff_Nj > 0.3)
          _count_C_loose ->fill(0.5);
      }
      ...
      if( min_dPhi_3 > 0.4 && min_dPhi_All > 0.2 && eTmiss/m_eff_Nj > 0.15 ) {
        ...
        if(m_eff_inc>1700.) _count_D_tight ->fill(0.5);
      }
      ...
      if( min_dPhi_3 > 0.4 && min_dPhi_All > 0.2 && eTmiss/m_eff_Nj > 0.15 ) {
        _hist_meff_E_tight->fill(m_eff_inc);
        if( eTmiss/m_eff_Nj > 0.25 )
          _hist_meff_E_medium->fill(m_eff_inc);
        if( eTmiss/m_eff_Nj > 0.3 )
          _hist_meff_E_loose->fill(m_eff_inc);
        if(m_eff_inc>1400.) _count_E_tight ->fill(0.5);
        if(m_eff_inc>1300.&& eTmiss/m_eff_Nj > 0.25 )
          _count_E_medium->fill(0.5);
        if(m_eff_inc>1000.&& eTmiss/m_eff_Nj > 0.3  )
          _count_E_loose ->fill(0.5);
      }
    }
